...
<link rel="stylesheet" href="../../css/mypages/mypage.css?ver=2">
<link rel="stylesheet" href="../../css/mypages/mypagesent.css?ver=2">
		...
		<div id="kakaoWrap" class="default head_bnr head_etc">
				...
				<c:if test="${empty sentList}">
					...
					<div class="main_mypage">
						<h4 class="tit_mypage">
							...
							<ul class="list_tit">
								<li><a class="link_tit" href="<%=contextPath %>/pages/mypage/received.do?id=email">받은
										선물함</a></li>
								<li class="on"><a class="link_tit"
									href="<%=contextPath %>/pages/mypage/sent.do?id=email">보낸 선물함<span class="screen_out">선택됨</span></a></li>
							</ul>
						</h4>
						<strong class="screen_out">보낸 선물함 본문</strong>
							
						
						<div class="area_empty">
							<div class="inner_area">
								<img class="img_empty"
									src="https://t1.kakaocdn.net/estoreweb/images/20220421091219/empty_gift.png"
									alt="사용한 쿠폰 없음 이미지"><strong class="tit_empty">보낸
									선물이 없습니다.</strong>
								<p class="desc_empty">친구들에게 이모티콘을 선물로 보내세요!</p>
							</div>
						</div>
					</div>	
				</div>
			...
			<c:if test="${not empty sentList}">
				<div class="area_mypage">
					...
					<ul class="list_item">	
						<c:forEach items="${sentList}" var="dto">
							<li class="item_unit"><strong class="date_item">${dto.gb_date}</strong><span
								class="txt_account">To.<span class="account_id">${dto.m_nn}
										</span></span>
							<div class="area_itemlist">
									<dl class="item_list">
										<dt>결제번호</dt>
										<dd class="txt_num">${dto.gb_seq}</dd>
										<dt>결제금액</dt>
										<dd class="txt_price">
											<em class="txt_num">${dto.gb_payprice}</em>원
										</dd>
									</dl>
									<dl class="item_list">
										<dt>결제수단</dt>
