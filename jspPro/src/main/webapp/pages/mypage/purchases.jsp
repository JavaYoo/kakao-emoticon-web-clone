		...
		<div id="root" style="height: 100%;">
					...
					<div class="inner_topbnr">
						<a
							...
							class="unit_coupon"><img
								...
								class="img_coupon" alt="띠배너이미지"></span>
							</a>
					</div>
			...
			<div id="kakaoHead" class="emoticon_head">
				...
				<div class="k_head">
					...
					<button class="link_search" id="btn1">
			...
			<div id="kakaoContent" class="cont_mypage">
				<!-- 구매내역 없는 경우 -->
				<c:if test="${empty purchasestList }">
						...
						<div class="area_tabbnr">
							<div class="tabbnr_header">
								...
								<ul class="list_tab" >
									...
									<li class="">
										<a class="link_tab" href="<%=contextPath %>/pages/mypage/coupons.do?id=email">쿠폰함
												<c:if test="${not empty couponsList}">
									...
									<li class="">
										<a class="link_tab" href="<%=contextPath %>/pages/mypage/likes.do?id=email">좋아요
					...
					<div class="main_mypage">
						<h4 class="tit_mypage">
							<span class="txt_tit">구매내역</span>
						</h4>
						<strong class="screen_out">구매내역 본문</strong>
							
						<div class="area_empty">
							<div class="inner_area">
								<img class="img_empty"
									src="https://t1.kakaocdn.net/estoreweb/images/20220421091219/empty_purchase.png"
									alt="구매내용 없음 이미지"><strong class="tit_empty">이모티콘샵 구매내역이
									 없습니다.</strong>
								<p class="desc_empty">모바일앱에서 구매한 내역은<br>'카카오톡>이모티콘스토어>내 이모티콘'에서 확인할 수 있습니다.</p>
			...
			<!-- 구매내역 있는 경우 -->
			<c:if test="${not empty purchasestList}">
				...
				<div class="area_mypage">
					...
					<ul class="list_item" >		
						<c:forEach items="${purchasestList}" var="dto">
								<li class="item_unit"><strong class="date_item">${dto.bl_date}</strong>
...
$("#logout").on("click",function(){
	...
	location.href="sidemenu/logout.jsp";
