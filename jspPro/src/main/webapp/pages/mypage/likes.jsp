...
<title>2022. 6. 30.-오후 2:15:47</title>
					...
					<div class="main_mypage">
						...
						<div class="area_empty">
							<div class="inner_area">
								<img class="img_empty"
									src="https://t1.kakaocdn.net/estoreweb/images/20220421091219/empty_like.png"
									alt="사용한 쿠폰 없음 이미지"><strong class="tit_empty">좋아하는
									이모티콘이 없습니다.</strong>
				...
				<div class="area_mypage">
					...
					<div class="main_mypage">
						...
						<ul class="list_emoticonshop list_like">
							<c:forEach items="${likesList}" var="dto">
							<li class="on"><div class="link_new">
									...
									<div class="area_tit">
									     <!-- 상세 이모티콘 경로로 가야함 -->
										<a class="link_tit" href="https://e.kakao.com/t/friendly-dog-couple-maltese-ver"><strong
											class="tit_product"><span class="area_icons"></span><span
												class="txt_tit">${dto.el_name}</span></strong><span
											class="txt_author">${dto.el_maker}</span></a>
										<button type="button" class="btn_grpshare">
											<span class="ico_comm ico_like ico_likeOn">좋아요</span>
										</button>
									</div>
								</div></li>
							</c:forEach>	
...
$(function (){
    $(".btn_grpshare").on("click", function(event) {
    	//alert("xx");
    	$.ajax({
            url:"/mypage/likesjson.do",  
            //url:"ex06_emp_json_lib.jsp",  
            dataType:"json",            // text, html, xml, script, 등등
             type:"POST",
             cache:false,                     // 꼭 기억
             data:{
            	 'id':qkreks12@daum.net,
            	 'num':32
             }
             success:function (data){ 
                ...
                // var empArray = data.emp;
                   ...
                   $(".tit_mypage .tit_num").html(data.count);
                } ) ;
