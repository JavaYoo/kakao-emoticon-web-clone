					...
					<div class="section_top">
						...
						<div class="area_tabfaq">
							...
							<ul class="tab_faq">
								...
								<li class="on"><a class="link_tab" href="../user/faqCancel.do">결제취소/환불<span
					...
					<div class="section_main">
						...
						<ul class="list_faq">
							<li class="" id="qa1"><a href="#" class="link_board"><span
									class="tit_board">결제 증빙 자료는 어디서 확인할 수 있나요?<span
										class="ico_comm ico_faqopen">답변 펼치기</span></span></a>
								<div class="desc_board">
									<p>
										<span style="font-family: Arial;">이모티콘을 구매하신 건에 대한 결제내역
											확인은 </span><br>
									</p>
									<p>
										<span style="font-family: Arial;"><b>이모티콘샵 &gt;
												[마이페이지] &gt; [구매내역] 또는 [선물함]</b>에서 확인하실 수 있습니다.</span>
									</p>
									<p>
										<br>
									</p>
									<p>
										<span style="font-family: Arial;">결제 증빙을 원하시는 경우, 구매시
											결제수단으로 사용하신 PG사(카드사, 혹은 통신사)의 홈페이지에서 거래내역조회를 통해 확인하실 수 있습니다.
										</span>
									</p>
									<p>
										<span style="font-family: Arial;">컬쳐캐쉬로 구매한 문화상품권 증빙의
											경우, 해당 상품권 발급쳐인 '컬쳐랜드' 에서 확인하실 수 있습니다.</span>
									</p>
								</div></li>
							<li class="" id="qa2"><a href="#" class="link_board"><span
									class="tit_board">결제수단은 어떤 것들이 제공되나요?<span
										class="ico_comm ico_faqopen">답변 펼치기</span></span></a>
								<div class="desc_board">
									<p>
										<span style="font-family: Arial;">이모티콘샵에서는 아래와 같은 결제수단을
											지원하고 있습니다. </span>
									</p>
									<p>
										<br>
									...
									<p>
										<span style="font-family: Arial;">∙ 카카오페이 (신용카드)</span>
									</p>
									<p>
										<span style="font-family: Arial;">∙ 카카오페이 (카드)</span><br>
									</p>
									<p>
										<span style="font-family: Arial;">∙ 카카오페이 (휴대폰)</span>
									</p>
									<p>
										<span style="font-family: Arial;">∙ 신용카드 일반</span>
									</p>
									<p>
										<span style="font-family: Arial;">∙ 휴대폰 결제</span>
									</p>
									<p>
										<span style="font-family: Arial;">∙ 문화상품권 (컬쳐랜드)&nbsp;</span>
									</p>
									<p>
										<span style="font-family: Arial;">∙ 해피머니 상품권</span>
									</p>
									<p>
										<span style="font-family: Arial;">∙ 도서문화상품권</span>
									</p>
								</div></li>
						</ul>
					</div>
