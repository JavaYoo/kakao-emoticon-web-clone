	...
	<form method="post">
		<table>
            ...
            <tr>
               ...
               <td>
                 <input type="text" name="qa_id" size="15" value="${ dto.qa_id }">
               </td>
            </tr>
            <tr>
               <td align="center">문의분류</td>
               <td>
                 <input type="text" name="qa_class" size="15" value="${ dto.qa_class }">
               </td>
            </tr>
            <tr>
               <td align="center">제목</td>
               <td>
                 <input type="text" name="qa_title" size="50"   value="${ dto.qa_title }">
               </td>
            </tr>
            <tr>
               <td align="center">내용</td>
               <td><textarea name="qa_content" cols="50" rows="10">${ dto.qa_content }</textarea>
               </td>
            </tr>
            <tr>
            	<td align="center">공개여부</td>
            	<td>
            		<input type="radio" name="qa_lock" value="1"  checked>공개
	               <input type="radio" name="qa_lock" value="0">비공개
	              </td>
	              <script>
	              	$(":radio[name=tag][value=${dto.qa_lock}]").attr("checked","checked")
	              </script>
            </tr>
            <tr>
