							...
							<c:forEach items="${ eList }" var="dto">
								...
								<div class="info_thumb">
									<div class="area_thumb">
										<c:if test="${param.el_num < 103 }">
											<img alt="카카오 이모티콘" class="thumb_img" src=${dto.el_mainimg }>
										</c:if>
										<c:if test="${ param.el_num >= 103 }">
											<img alt="카카오 이모티콘" class="thumb_img" src="/jspPro/upload/${ dto.el_name }/${dto.el_mainimg }" >
										</c:if>
									</div>
								</div>
						...
						<ul class="list_emoticon">
							<c:if test="${  not empty eList }">
								<c:forEach items="${eImgList }" var="dto" varStatus="status">
									<li class=""><a class="link_emoticon" href="#">
										<c:if test="${ dto.ei_num < 103 }">
											<img class="img_emoticon" src=${dto.ei_path }>
										</c:if>
										<c:if test="${ dto.ei_num >= 103 }">
											<img class="img_emoticon"  src="/jspPro/upload/${ dto.el_name }/${dto.ei_path }">
										</c:if>
										   <!-- <div class="box_send">
												<div class="area_send">
