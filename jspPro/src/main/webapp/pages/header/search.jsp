...
<body>
	...
	<div id="root" style="height: 100%;">
		...
		`							<span class="wrap_thumb"> 
					...
					<!-- <div class="dim_layer"></div> -->
				<div class="search_wrap on" style="display:none; top: 127px;">
					<form class="search-box__form" action="<%= contextPath %>/pages/header/search.do">
						<div class="inner_search">
							<h3 class="screen_out">이모티콘 검색어 입력</h3>
							<div class="emoticon_sch">
			...
			style="padding-top:110px" </c:if>  >
				...
				<c:if test="${ not empty param.q && not empty searchList }">
							...
							<c:forEach var="searchList" items="${ searchList }" varStatus="status">
								<li class="hot_item">
									<div class="double_tit">
										<a class="link_double" 
										href="<%=contextPath%>/pages/view/view.do?el_num=${ searchList.el_num }">
											<div class="area_tit">
									...
									<a class="link_double double_img" href="<%=contextPath%>/pages/view/view.do?el_num=${ searchList.el_num }">
